"""Entrypoint: ``python -m nexo_core [--config file] [--port N] ...``"""
...
def main(argv: list[str] | None = None) -> int:
    try:
        ...
        print(f"nexo-core: configuration error: {exc}", file=sys.stderr)
        return 2

"""FastAPI application assembly for NEXO Core.
...
* Management API (Bearer token via NEXO_CORE_API_TOKEN), consumed by the
  NEXO Worker on behalf of the Console:
...
class Core:
    ...
    def __init__(self, cfg: CoreConfig):
        ...
        self.app = FastAPI(title="NEXO Core", docs_url=None, redoc_url=None,
